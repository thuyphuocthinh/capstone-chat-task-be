...
public interface PrivateConversationService {
    public PrivateConversationDetailResponse createPrivateConversation(String workspaceId, CreatePrivateConversationRequest request) throws NotFoundException;
