...
public interface NotificationService {
    ...
    public SuccessResponseWithMetadata<?> getNotificationsByUser(String userId) throws NotFoundException;
    public SuccessResponseWithMetadata<?> getNotificationsByUserAndType(String userId, NOTIFICATION_TYPE type) throws NotFoundException;
}
